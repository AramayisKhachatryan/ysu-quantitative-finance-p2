...
\begin{frame}{Strong Co-movement Across the Sector}
    ...
    \begin{center}
        \includegraphics[width=0.55\textwidth]{../figures/Screenshot 2026-06-26 at 12.24.21.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{Model A: Market Model (contemporaneous)}
    ...
    \]
    \begin{center}
        \includegraphics[width=0.92\textwidth]{../figures/Unknown-6.png}
    \end{center}
...
\begin{frame}{Model B: Lagged Market $\to$ Stock Return}
    ...
    \]
    \begin{center}
        \includegraphics[width=0.92\textwidth]{../figures/Unknown-7.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{Model C: Own Lagged Return (AR1)}
    ...
    \]
    \begin{center}
        \includegraphics[width=0.92\textwidth]{../figures/Unknown-8.png}
    \end{center}
    \begin{itemize}
...
% ===================== STAGE 2 (results — numbers added) =====================
\begin{frame}{Stage 2: Results (AAPL full model)}
    \footnotesize
    Obtained model (only the significant term shown explicitly):
    \[
        \widehat{\text{AAPL}}_t \;\approx\; \hat\beta_0 \;+\; 1.23\,\text{S\&P 500}_t
        \;+\;(\text{6 small, insignificant terms})
    \]
    \normalsize
    \begin{center}
        \includegraphics[width=0.78\textwidth]{../figures/Unknown-9.png}
    \end{center}
    \begin{itemize}
        \item Only the \textbf{same-day market} term is significant:
              $\hat\beta_1 \approx 1.23$, $p < 0.001$ (matches the Stage-1 beta);
              the six lagged/technical terms are individually insignificant ($p > 0.05$)
...
% ===================== STAGE 3 (selection — numbers added) =====================
\begin{frame}{Stage 3: Model Selection (in- vs out-of-sample)}
    ...
    \begin{center}
        \includegraphics[width=0.62\textwidth]{../figures/Unknown-10.png}
    \end{center}
    \vspace{-2pt}
    {\footnotesize
    \begin{center}
        \begin{tabular}{lcc}
            \toprule
            Model & adj.\ $R^2$ & $R^2_{\text{OOS}}$ \\
            \midrule
            Market-only (M1)            & $\approx 0.56$ & $\approx 0.29$ \\
            Full, 7 predictors (M4)     & $\approx 0.56$ & $\approx 0.29$ \\
            Predictive, lagged-only (P) & $\approx 0.00$ & $\approx 0.00$ \\
            \bottomrule
        \end{tabular}
    \end{center}}
    \begin{itemize}
...
\begin{frame}{Extension: Beta Is Not Constant}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth]{../figures/Unknown-14.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{Extension: Systematic Share Over Time}
    ...
    \begin{center}
        \includegraphics[width=0.92\textwidth]{../figures/Unknown-13.png}
    \end{center}
    \begin{itemize}
