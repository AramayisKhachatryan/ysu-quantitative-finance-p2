...
\begin{frame}{Model 1: Results}
    ...
    \begin{table}
        ...
        \begin{tabular}{lcc}
            ...
            $\beta_1$ (NASDAQ$_t$)  & $0.940$   & $\approx 5\times10^{-260}$ \\
            \bottomrule
        \end{tabular}
    \end{table}
    ...
    \begin{itemize}
        ...
        \item Residuals are fat-tailed (kurtosis $\approx 6$) -- typical of daily financial returns
    \end{itemize}
\end{frame}
...
\begin{frame}{Model 2: Results}
    ...
    \begin{table}
        ...
        \begin{tabular}{lcc}
            ...
            $\beta_1$ (NASDAQ$_{t-1}$) & $-0.0024$ & $0.943$ (not significant) \\
            \bottomrule
        \end{tabular}
    \end{table}
...
\begin{frame}{Model A: Full Lagged Model}
    ...
    \footnotesize
    \[
        \text{AAPL}_t = \beta_0 + \beta_1 \text{NASDAQ}_{t-1} + \beta_2 \text{AAPL}_{t-1} +\]
...
\begin{frame}{Model B: Reduced Model}
    \[
        \text{AAPL}_t = \beta_0 + \beta_1 \cdot \text{NASDAQ}_{t-1} + \beta_2 \cdot \text{AAPL}_{t-1} + \varepsilon_t
    \]
    \begin{table}
        \centering
        \begin{tabular}{lcc}
            ...
            $\beta_1$ (\texttt{NASDAQ\_lag1})  & $-0.0007$ & $0.383$ \\
...
\begin{frame}{Residual Diagnostics (Model C)}
    \begin{itemize}
        ...
        \item Residuals are fat-tailed (kurtosis $\approx 8.7$) -- normality is rejected
        \item Same pattern as Stage 1 -- typical of daily financial returns, and
